...
def monster_mash():
    ...
    stakedao_vesdt_lockers = unique_to_df(df_stakedao_vesdt.provider, 'stakedao_vesdt_locker')
    stakedao_sdcrv_stakers = unique_to_df(df_stakedao_sdcrv.provider, 'stakedao_sdcrv_staker')
