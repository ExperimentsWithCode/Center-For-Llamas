...
from app.snapshot.delegations.process_flipside import ProcessConvexDelegations
...
def process_and_get(save=False):
    ...
    pcb = ProcessConvexDelegations(df_delegations, df_convex_snapshot_vote_choice, df_convex_locker_agg_user_epoch)
